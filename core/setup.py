...
def post_login_init(state, screen, reg_font, small_font):
    ...
    quit_button = Button(pygame.Rect(200, 600, 200, 50), lambda: f"QUIT", lambda: game_flow.stop_game(True, state, sounds))
    ...
    quit_button = Button(pygame.Rect(config.WIDTH - 400, 350, 200, 50), lambda: f"QUIT", lambda: game_flow.stop_game(True, state, sounds))
